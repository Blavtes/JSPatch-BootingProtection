...
- (void)showAlertForFixContinuousCrashOnCompletion:(BoolCompletionBlock)completion {
    DLog(@"Detect continuous crash %ld times. Prompt user to fix.",  (long)[GYBootingProtection crashCount]);
